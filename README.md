# Movie App
Movie App created with React. The application is using public api (https://www.themoviedb.org/). Users can view over 10 000 movies, tv shows, celebs. User can search for specific movie, tv or celeb. It has implemented paging and sorting by popularity, revenue, vote counts and vote average. The app styling and responsive design is created with pure css.

## [Link to the hosted project](https://react-movies-3451e.web.app)
